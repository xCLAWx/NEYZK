...
NEYZK = Token:match("(%d+)")
redis:mset(
NEYZK..":VERSION",GetUser.information.Source_version,
NEYZK..":SUDO_ID:",GetUser.information.id,
NEYZK..":DataCenter:",GetUser.information.DataCenter,
NEYZK..":UserNameBot:",BOT_User,
NEYZK..":ApiSource",GetUser.information.WebSite,
NEYZK..":NameBot:","النيزك",
"TH3NEYZK_INSTALL","Yes"
)
redis:hset(NEYZK..'username:'..GetUser.information.id,'username','@'..GetUser.information.username:gsub('_',[[\_]]))
info = {} 
